        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <div className="text-center">
                <span className="text-3xl font-serif font-bold text-primary">4.6</span>
          ...
          >
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold mt-3 mb-6">
              A Taste of the <span className="text-gradient-gold">Himalayas</span>
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Nestled in the heart of Mall Road, Uttarkashi, JH Butter Momos & Soup Bar brings you the authentic flavors of Tibetan cuisine. Our signature butter momos, made with love and premium ingredients, have become a beloved delicacy for locals and travelers alike.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-10">
              From our famous Paneer Butter Momos to the soul-warming Tibetan Thupka soup, every dish tells a story of tradition, quality, and the warm hospitality of the mountains.
            </p>
